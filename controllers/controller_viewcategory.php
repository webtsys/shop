...
class  ViewcategorySwitchClass extends ControllerSwitchClass
{
	...
	function index($idcat_product=0, $title_slugify='')
	{
		...
		if($arr_cat['IdCat_product']==0)
		{
			...
			$arr_cat['title']=PhangoVar::$lang['shop']['all_products'];
			$arr_cat['description']=PhangoVar::$lang['shop']['desc_all_products'];
			$arr_cat['subcat']=0;
		...
		PhangoVar::$model['product']->forms['title_'.$_SESSION['language']]->label=PhangoVar::$lang['common']['title'];
